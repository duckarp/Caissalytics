...
public class LocalizationService : ILocalizationService
{
    ...
    private static Dictionary<string, string> GetEnglishStrings() => new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Nav_Messages_Tooltip"] = "Club & Coaching Group Messages",
        ...
        ["Dash_Group_Training"] = "Play & Training",
        ["Dash_Group_Training_Desc"] = "Interactive analysis, engine sparring, tactical puzzles, endgames, and repertoire",
        ["Dash_Group_Insights"] = "Preparation & Insights",
        ["Dash_Group_Insights_Desc"] = "Master databases, opponent scouting dossiers, game libraries, and performance analytics",
        ...
        ["Dash_Card_Practice"] = "Practice vs Computer",
        ["Dash_Card_Practice_Desc"] = "Play against a computer opponent calibrated to any Elo rating, with takebacks, hints, and post-game analysis.",
        ...
        ["Dash_Card_ClubHomework"] = "Club Homework",
        ["Dash_Card_ClubHomework_Desc"] = "Solve homework assigned by your chess coach, record moves on an interactive board, and submit solutions directly to the club portal.",
        ...
        ["Settings_Nav_Club"] = "Chess Club",
        ["Settings_Nav_Club_Desc"] = "Club or school name, coaching defaults",
        ...
        ["Tab_Practice"] = "Practice ({0})",
        ["Tab_Homework"] = "Homework & Diagrams",
        ["Tab_ClubHomework"] = "Club Homework",
        ["Tab_Messages"] = "Club Messages",
        ...
        ["Analysis_LoadPgn"] = "📂 Load PGN",
        ["Analysis_LoadPgnShort"] = "Load PGN",
        ["Analysis_LoadPgn_Title"] = "📂 Load PGN into Analysis",
        ["Analysis_LoadPgn_Desc"] = "Paste PGN text or select a .pgn file to load the game into the analysis board.",
        ["Analysis_LoadPgn_FileBtn"] = "Choose .pgn file",
        ["Analysis_LoadPgn_PasteClipboard"] = "📋 Paste from clipboard",
        ["Analysis_LoadPgn_Open"] = "Open Game",
        ["Analysis_LoadPgn_OpenNewTab"] = "Open in a new tab",
        ["Analysis_LoadPgn_Invalid"] = "No valid chess moves or PGN headers detected.",
        ["Analysis_LoadPgn_Preview"] = "Detected Game",
        ["Analysis_LoadPgn_Clear"] = "Clear text",
        ...
        ["Analysis_Date"] = "Date:",
        ["Analysis_Round"] = "Round:",
        ["Analysis_Board"] = "Board:",
        ["Analysis_Result"] = "Result:",
        ["Analysis_Eco"] = "ECO:",
        ["Analysis_TimeControl"] = "Time Control:",
        ["Analysis_Fen"] = "FEN",
        ...
        ["Db_Filter_Eco"] = "ECO",
        ["Db_Filter_Opening"] = "Opening",
        ["Db_Filter_OpeningPlaceholder"] = "e.g. Bird's Opening",
        ...
        ["Db_Filter_Position"] = "♟️ Position",
        ["Db_Filter_PositionActive"] = "Position filter active",
        ["Db_Filter_ClearPosition"] = "Clear position filter",
        ["Db_Filter_ModalTitle"] = "Filter Games by Board Position",
        ["RefTree_ViewInDatabase"] = "View in Database ↗",
        ["Db_Col_Site"] = "Site",
        ["Db_Col_White"] = "White",
        ["Db_Col_Black"] = "Black",
        ["Db_Col_Elo"] = "Elo",
        ...
        ["Db_Col_Moves"] = "Moves",
        ["Db_Col_Time"] = "Time",
        ["Db_Time_Bullet"] = "Bullet",
        ["Db_Time_Blitz"] = "Blitz",
        ["Db_Time_Rapid"] = "Rapid",
        ["Db_Time_Standard"] = "Standard",
        ["Db_OpenGame"] = "Open",
        ...
        ["Db_NewDb_Tab_Create"] = "New Database",
        ["Db_NewDb_Tab_Remote"] = "Download",
        ["Db_NewDb_Tab_Import"] = "Import PGN",
        ...
        ["Homework_CoachingNotes"] = "Coaching Notes & Lesson Plan",
        ["Homework_NotesPosition"] = "Notes Placement",
        ["Homework_NotesTop"] = "Top (Above diagrams)",
        ["Homework_NotesBottom"] = "Bottom (Below diagrams)",
        ["Homework_NotesHide"] = "Do not show",
        ["Homework_DiagramSize"] = "Diagram Size",
        ["Homework_SizeSmall"] = "Small (Compact)",
        ["Homework_SizeMedium"] = "Medium (Standard)",
        ["Homework_SizeLarge"] = "Large (Coaching Focus)",
        ["Homework_Col1"] = "1 Column (Focus / Coaching)",
        ["Homework_InsertTemplate"] = "Insert Lesson Template",
        ["Homework_CreateEmptySheet"] = "Create Empty Sheet",
        ["Homework_CreateFromTemplate"] = "Create from Template",
        ["Homework_TemplateCoaching"] = "Coach Notes (2 Diagrams)",
        ["Homework_TemplateCoachingDesc"] = "2 diagrams + editable coach lesson plan & talking points",
        ["Homework_Template4"] = "Tactics Drill (4 Diagrams)",
        ["Homework_Template4Desc"] = "4 tactical positions in a 2x2 grid",
        ["Homework_Template6"] = "Homework Worksheet (6 Diagrams)",
        ["Homework_Template6Desc"] = "6 tactical positions in a 2x3 grid",
        ["Homework_Template8"] = "Club Practice Sheet (8 Diagrams)",
        ["Homework_Template8Desc"] = "8 intensive exercises in a 2x4 grid",
        ["Homework_PreviewNotes"] = "Preview",
        ["Homework_EditNotes"] = "Notes (Markdown)",

        // Chess Club Settings
        ["Club_Title"] = "Chess Club & School",
        ["Club_Desc"] = "Configure your chess club or school details. These defaults will be prefilled on new homework and coaching sheets.",
        ["Club_ClubName"] = "Chess Club / School",
        ["Club_ClubName_Hint"] = "Name of your chess club, school, or coaching academy.",
        ...
        // SKPP Web Platform Integration
        ["Skpp_SectionTitle"] = "Web Platform Hub Integration",
        ["Skpp_SectionDesc"] = "Connect Caissalytics to your compatible chess club portal for coaching groups, homework synchronization, and communications.",
        ["Skpp_ApiUrl"] = "API Base URL",
        ["Skpp_ApiUrl_Hint"] = "Address of the club web API server (e.g. http://localhost:5000 or https://skpp.sk).",
        ["Skpp_SaveUrl"] = "Save URL",
        ["Skpp_Status_Connected"] = "Connected",
        ["Skpp_Status_Disconnected"] = "Disconnected",
        ["Skpp_UsernameOrEmail"] = "Username or Email",
        ["Skpp_Password"] = "Password",
        ["Skpp_Password_Hint"] = "Password is used for direct token exchange and is never stored on disk.",
        ["Skpp_ConnectBtn"] = "Connect to Hub",
        ["Skpp_Connecting"] = "Connecting...",
        ["Skpp_DisconnectBtn"] = "Disconnect",
        ["Skpp_VerifyBtn"] = "Refresh / Verify Profile",
        ["Skpp_Verifying"] = "Verifying...",
        ["Skpp_RoleCoach"] = "Coach",
        ["Skpp_RoleStudent"] = "Student",
        ["Skpp_AccountInfo"] = "Connected Account",
        ["Skpp_CoachingGroups"] = "Coaching Groups",
        ["Skpp_NoGroups"] = "No coaching groups assigned to this account.",
        ["Skpp_PrimaryCoach"] = "Primary Coach",
        ["Skpp_StudentsCount"] = "{0} students enrolled",
        ["Skpp_Ratings"] = "FIDE Ratings",
        ["Skpp_FideId"] = "FIDE ID",
        ["Skpp_ConnectedSuccess"] = "Successfully connected to hub!",

        // Student Club Homeworks
        ["Homework_Tab_Worksheets"] = "Worksheets & Printables",
        ["Homework_Tab_ClubAssigned"] = "Club Assigned Tasks",
        ["Homework_Club_NotConnected"] = "Not Connected to Club Portal",
        ["Homework_Club_NotConnectedDesc"] = "Connect Caissalytics to your chess club portal in the Control Center to receive homework assignments directly from your coach.",
        ["Homework_Club_ConnectBtn"] = "Connect in Settings ⚙️",
        ["Homework_Club_Loading"] = "Loading assigned club homeworks...",
        ["Homework_Club_NoTasks"] = "No tasks assigned yet",
        ["Homework_Club_NoTasksDesc"] = "Your coach has not assigned any homework tasks to your group yet.",
        ["Homework_Club_Refresh"] = "Refresh Tasks",
        ["Homework_Club_DueDate"] = "Due: {0}",
        ["Homework_Club_NoDueDate"] = "No due date",
        ["Homework_Club_Overdue"] = "Overdue",
        ["Homework_Club_AssignedBy"] = "Assigned by {0}",
        ["Homework_Club_Status_Assigned"] = "Pending Solution",
        ["Homework_Club_Status_Submitted"] = "Submitted",
        ["Homework_Club_Status_Reviewed"] = "Reviewed",
        ["Homework_Club_SolveTask"] = "Solve Task",
        ["Homework_Club_ViewSubmission"] = "View Submission",
        ["Homework_Solver_Back"] = "Back to Club Homeworks",
        ["Homework_Solver_Instructions"] = "Coach Instructions",
        ["Homework_Solver_YourSolution"] = "Your Proposed Solution",
        ["Homework_Solver_MovesLine"] = "Moves Played on Board",
        ["Homework_Solver_Explanation"] = "Written Explanation / Solution Notes",
        ["Homework_Solver_ExplanationPlaceholder"] = "Explain your thinking, key defense, or why this tactic works...",
        ["Homework_Solver_SubmitBtn"] = "Submit Solution to Coach",
        ["Homework_Solver_Submitting"] = "Submitting solution...",
        ["Homework_Solver_ResetBoard"] = "Reset Board",
        ["Homework_Solver_SubmittedOn"] = "Submitted on {0}",
        ["Homework_Solver_WaitingReview"] = "Your solution was received and is awaiting coach review.",
        ["Homework_Solver_ReviewedOn"] = "Reviewed by coach on {0}",
        ["Homework_Solver_PointsAwarded"] = "Score Awarded: {0} pts",
        ["Homework_Solver_CoachFeedback"] = "Coach Feedback",
        ["Homework_Solver_OfficialSolution"] = "Official Coach Solution",
        ["Homework_Solver_SuccessToast"] = "Solution submitted successfully to coach!",

        // Club & Coaching Group Messages
        ["Messages_Title"] = "Club Messages",
        ["Messages_NewMessage"] = "New Message",
        ["Messages_Refresh"] = "Refresh Messages",
        ["Messages_SearchPlaceholder"] = "Search messages...",
        ["Messages_Filter_All"] = "All",
        ["Messages_Filter_Unread"] = "Unread",
        ["Messages_Loading"] = "Loading club messages...",
        ["Messages_NoMessages"] = "No messages found",
        ["Messages_UnreadTag"] = "Unread message",
        ["Messages_System"] = "System",
        ["Messages_Direct"] = "Direct",
        ["Messages_Coach"] = "Coach",
        ["Messages_ReplyTitle"] = "Reply to Message",
        ["Messages_SendTo"] = "To Coaching Group / Recipient",
        ["Messages_NoGroupsAvailable"] = "No coaching groups available",
        ["Messages_Subject"] = "Subject",
        ["Messages_SubjectPlaceholder"] = "Enter message subject...",
        ["Messages_Body"] = "Message Content",
        ["Messages_BodyPlaceholder"] = "Write your message to your coach or group here...",
        ["Messages_Sending"] = "Sending...",
        ["Messages_SendBtn"] = "Send Message",
        ["Messages_ReplyBtn"] = "Reply",
        ["Messages_ReferenceHomeworkTitle"] = "Referenced Homework Task",
        ["Messages_ReferenceHomeworkDesc"] = "This message references an online homework assignment.",
        ["Messages_OpenReferenceTask"] = "Open Homework Task",
        ["Messages_SelectToRead"] = "No message selected",
        ["Messages_SelectToReadDesc"] = "Select a message from the left to read its content or compose a new one.",
        ["Messages_SubjectRequired"] = "Subject cannot be empty.",
        ["Messages_BodyRequired"] = "Message content cannot be empty.",
        ["Messages_SentSuccess"] = "Message sent successfully!",

        // Practice & Play vs PC
        ["Analysis_PlayVsPc"] = "Play vs PC",
        ["PlayVsPc_Title"] = "Play vs Computer From Position",
        ["PlayVsPc_Desc"] = "Start a practice match from the current board position. Choose your side and the opponent's simulated Elo rating.",
        ["PlayVsPc_Side"] = "Your Side",
        ["PlayVsPc_White"] = "White",
        ["PlayVsPc_Black"] = "Black",
        ["PlayVsPc_Current"] = "Side to move ({0})",
        ["PlayVsPc_OpponentElo"] = "Opponent Strength (Elo: {0})",
        ["PlayVsPc_Preset_Beginner"] = "Beginner (1000)",
        ["PlayVsPc_Preset_Casual"] = "Casual (1300)",
        ["PlayVsPc_Preset_Intermediate"] = "Intermediate (1600)",
        ["PlayVsPc_Preset_Club"] = "Club Player (1900)",
        ["PlayVsPc_Preset_Master"] = "Master (2200)",
        ["PlayVsPc_Preset_Grandmaster"] = "Grandmaster (2500+)",
        ["PlayVsPc_Start"] = "Start Match",
        ["PlayVsPc_Cancel"] = "Cancel",

        ["Practice_Opponent"] = "Computer Bot",
        ["Practice_Thinking"] = "Computer is thinking...",
        ["Practice_YourTurn"] = "Your turn to move",
        ["Practice_Takeback"] = "Takeback",
        ["Practice_Hint"] = "Hint",
        ["Practice_Resign"] = "Resign",
        ["Practice_Draw"] = "Offer Draw",
        ["Practice_NewGame"] = "New Match",
        ["Practice_Analyze"] = "Analyze Game",
        ["Practice_EvalToggle"] = "Eval Gauge",
        ["Practice_Victory"] = "Checkmate! You won! 🎉",
        ["Practice_Defeat"] = "Checkmate! Computer won.",
        ["Practice_Stalemate"] = "Draw by stalemate!",
        ["Practice_DrawAgreed"] = "Draw agreed.",
        ["Practice_Resigned"] = "You resigned.",
        ["Practice_CompResigned"] = "Computer resigned. You won! 🎉",
        ["Practice_HintText"] = "💡 Suggested move: {0}",
        ["Practice_HintNotFound"] = "No clear hint found.",
        ["Practice_StrengthTitle"] = "Bot Strength & Difficulty",
        ["Practice_StrengthDesc"] = "Calibrate the computer's simulated rating before starting or after completing a match.",
        ["Practice_StrengthLocked"] = "Locked in Match",
        ["Practice_DifficultyLockedDesc"] = "Bot strength is locked once the game starts. Finish or restart the match to change difficulty.",
        ["Practice_NewMatchTitle"] = "New Match Setup",
        ["Practice_SideWhite"] = "Play White ♔",
        ["Practice_SideBlack"] = "Play Black ♚",
        ["Practice_StartNew"] = "Start Fresh Match",

        ["Practice_Engine_Stockfish"] = "Stockfish",
        ["Practice_Engine_Maia"] = "Maia Neural Net",
        ["Practice_Maia_Desc"] = "Authentic human move prediction trained directly on millions of human games.",
        ["Practice_Maia_DownloadBtn"] = "Download Maia {0} (~1.2 MB)",
        ["Practice_Maia_Downloading"] = "Downloading Maia {0} ({1}%)...",
        ["Practice_Maia_Lc0Missing"] = "Leela Chess Zero (lc0) is required to run Maia. Go to Settings → Engines to install it or set a custom path.",
        ["Practice_Maia_Lc0Missing_Tooltip"] = "lc0 not installed — go to Settings → Engines to set it up",
        ["Practice_Maia_Lc0Configure"] = "Configure lc0 in Settings",
        ["Settings_Maia_Title"] = "Maia Chess Neural Networks",
        ["Settings_Maia_Subtitle"] = "Authentic human play prediction models (1100 to 1900 Elo) powered by Leela Chess Zero (lc0).",
        ["Settings_Maia_Desc"] = "Authentic human play prediction models (1100 to 1900 Elo) powered by Leela Chess Zero (lc0).",
        ["Settings_Maia_Lc0Status"] = "Lc0 Binary Status",
        ["Settings_Maia_Lc0Detected"] = "Lc0 binary ready at: {0}",
        ["Settings_Maia_Lc0NotFound"] = "Lc0 binary not found in PATH or managed folder.",
        ["Settings_Maia_CustomLc0Placeholder"] = "Path to lc0 executable...",
        ["Settings_Maia_CustomLc0Path"] = "Custom lc0 Binary Path",
        ["Settings_Maia_CustomLc0Hint"] = "Specify full path to lc0 binary if installed in a non-standard location.",
        ["Settings_Maia_Lc0PathSaved"] = "Custom lc0 path saved successfully!",
        ["Settings_Maia_ModelsTitle"] = "Maia Neural Weights (~1.2 MB each)",
        ["Settings_Maia_ModelsDesc"] = "Offline policy weights trained on human games from 1100 to 1900 rating.",
        ["Settings_Maia_DownloadAll"] = "Download All Models (11 MB)",
        ["Settings_Maia_DownloadAllProgress"] = "Downloading all models ({0}%)...",
        ["Settings_Maia_Installed"] = "Installed",
        ["Settings_Maia_NotInstalled"] = "Not downloaded",
        ["Settings_Maia_Download"] = "Download",
        ["Settings_Maia_Size"] = "{0:F1} MB",
        ["Settings_Maia_Lc0Download"] = "⬇ 1-Click Download lc0 (Windows)",
        ["Settings_Maia_Lc0Build"] = "Build lc0 from source (~2 min)",
        ["Settings_Maia_Lc0Required"] = "Install lc0 above to enable Maia model downloads."
    };
    ...
    private static Dictionary<string, string> GetSlovakStrings() => new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Nav_Messages"] = "Správy",
        ["Nav_Messages_Tooltip"] = "Klubová pošta a správy tréningových skupín",
        ...
        ["Dash_Group_Training"] = "Hra & Tréning",
        ["Dash_Group_Training_Desc"] = "Interaktívna analýza, tréning proti počítaču, taktika, koncovky a repertoár",
        ["Dash_Group_Insights"] = "Príprava & Prehľady",
        ["Dash_Group_Insights_Desc"] = "Majstrovské databázy, príprava na súperov, knižnice partií a osobná analytika",
        ...
        ["Dash_Card_Practice"] = "Tréning proti PC",
        ["Dash_Card_Practice_Desc"] = "Hrajte proti počítačovému súperovi kalibrovanému na ľubovoľné Elo, s možnosťou vrátenia ťahov, nápovedy a analýzy hry.",
        ...
        ["Dash_Card_ClubHomework"] = "Klubové domáce úlohy",
        ["Dash_Card_ClubHomework_Desc"] = "Riešte domáce úlohy zadané vaším trénerom, zaznamenávajte ťahy na šachovnici a odosielajte riešenia priamo do klubového portálu.",
        ...
        ["Settings_Nav_Club"] = "Šachový klub",
        ["Settings_Nav_Club_Desc"] = "Názov klubu alebo školy, predvoľby pre tréning",
        ...
        ["Tab_Practice"] = "Tréning ({0})",
        ["Tab_Homework"] = "Pracovné listy & diagramy",
        ["Tab_ClubHomework"] = "Klubové domáce úlohy",
        ["Tab_Messages"] = "Klubové správy",
        ...
        ["Analysis_Tab_Tools"] = "PGN & FEN",
        ["Analysis_LoadPgn"] = "📂 Načítať PGN",
        ["Analysis_LoadPgnShort"] = "Načítať PGN",
        ["Analysis_LoadPgn_Title"] = "📂 Načítať PGN do analýzy",
        ["Analysis_LoadPgn_Desc"] = "Vložte PGN text alebo vyberte .pgn súbor pre načítanie partie do analýzy.",
        ["Analysis_LoadPgn_FileBtn"] = "Vybrať .pgn súbor",
        ["Analysis_LoadPgn_PasteClipboard"] = "📋 Vložiť zo schránky",
        ["Analysis_LoadPgn_Open"] = "Otvoriť partiu",
        ["Analysis_LoadPgn_OpenNewTab"] = "Otvoriť v novej záložke",
        ["Analysis_LoadPgn_Invalid"] = "Neboli rozpoznané žiadne platné šachové ťahy ani PGN hlavičky.",
        ["Analysis_LoadPgn_Preview"] = "Rozpoznaná partia",
        ["Analysis_LoadPgn_Clear"] = "Vymazať text",
        ...
        ["Analysis_Date"] = "Dátum:",
        ["Analysis_Round"] = "Kolo:",
        ["Analysis_Board"] = "Šachovnica:",
        ["Analysis_Result"] = "Výsledok:",
        ["Analysis_Eco"] = "ECO:",
        ["Analysis_TimeControl"] = "Časová kontrola:",
        ["Analysis_Fen"] = "FEN",
        ...
        ["Db_Filter_Eco"] = "ECO",
        ["Db_Filter_Opening"] = "Otvorenie",
        ["Db_Filter_OpeningPlaceholder"] = "napr. Birdovo otvorenie",
        ["Db_Filter_MinElo"] = "Min. Elo",
        ...
        ["Db_Filter_Reset"] = "Reset",
        ["Db_Filter_Position"] = "♟️ Pozícia",
        ["Db_Filter_PositionActive"] = "Filter pozície aktívny",
        ["Db_Filter_ClearPosition"] = "Zrušiť filter pozície",
        ["Db_Filter_ModalTitle"] = "Filtrovať partie podľa pozície",
        ["RefTree_ViewInDatabase"] = "Zobraziť v databáze ↗",
        ...
        ["Db_NewDb_Tab_Create"] = "Nová databáza",
        ["Db_NewDb_Tab_Remote"] = "Stiahnuť",
        ["Db_NewDb_Tab_Import"] = "Importovať PGN",
        ...
        ["Homework_CoachingNotes"] = "Trénerské poznámky a plán hodiny",
        ["Homework_NotesPosition"] = "Umiestnenie poznámok",
        ["Homework_NotesTop"] = "Hore (nad diagramami)",
        ["Homework_NotesBottom"] = "Dole (pod diagramami)",
        ["Homework_NotesHide"] = "Nezobrazovať",
        ["Homework_DiagramSize"] = "Veľkosť diagramov",
        ["Homework_SizeSmall"] = "Malá (kompaktná)",
        ["Homework_SizeMedium"] = "Stredná (štandardná)",
        ["Homework_SizeLarge"] = "Veľká (trénerské zameranie)",
        ["Homework_Col1"] = "1 stĺpec (zameranie / tréning)",
        ["Homework_InsertTemplate"] = "Vložiť šablónu hodiny",
        ["Homework_CreateEmptySheet"] = "Vytvoriť prázdny list",
        ["Homework_CreateFromTemplate"] = "Vytvoriť zo šablóny",
        ["Homework_TemplateCoaching"] = "Trénerské poznámky (2 diagramy)",
        ["Homework_TemplateCoachingDesc"] = "2 diagramy + upraviteľný plán hodiny a poznámky",
        ["Homework_Template4"] = "Taktické cvičenia (4 diagramy)",
        ["Homework_Template4Desc"] = "4 taktické pozície v mriežke 2x2",
        ["Homework_Template6"] = "Pracovný list (6 diagramov)",
        ["Homework_Template6Desc"] = "6 taktických úloh v mriežke 2x3",
        ["Homework_Template8"] = "Klubový hárok (8 diagramov)",
        ["Homework_Template8Desc"] = "8 intenzívnych úloh v mriežke 2x4",
        ["Homework_PreviewNotes"] = "Náhľad",
        ["Homework_EditNotes"] = "Poznámky (Markdown)",

        // Chess Club Settings
        ["Club_Title"] = "Šachový klub & Škola",
        ["Club_Desc"] = "Nastavte údaje o vašom šachovom klube alebo škole. Tieto predvoľby sa automaticky predvyplnia pri vytváraní nových domácich úloh.",
        ["Club_ClubName"] = "Šachový klub / Škola",
        ["Club_ClubName_Hint"] = "Názov vášho šachového klubu, školy alebo tréningového krúžku.",
        ...
        // SKPP Web Platform Integration
        ["Skpp_SectionTitle"] = "Integrácia webového portálu",
        ["Skpp_SectionDesc"] = "Prepojte Caissalytics s kompatibilným klubovým webovým portálom pre synchronizáciu tréningových skupín, úloh a komunikáciu.",
        ["Skpp_ApiUrl"] = "Základná adresa API",
        ["Skpp_ApiUrl_Hint"] = "Adresa servera klubového webového API (napr. http://localhost:5000 alebo https://skpp.sk).",
        ["Skpp_SaveUrl"] = "Uložiť URL",
        ["Skpp_Status_Connected"] = "Pripojené",
        ["Skpp_Status_Disconnected"] = "Odpojené",
        ["Skpp_UsernameOrEmail"] = "Používateľské meno alebo email",
        ["Skpp_Password"] = "Heslo",
        ["Skpp_Password_Hint"] = "Heslo sa použije výhradne na získanie bezpečnostného tokenu a nikdy sa neukladá na disk.",
        ["Skpp_ConnectBtn"] = "Pripojiť k portálu",
        ["Skpp_Connecting"] = "Pripájam...",
        ["Skpp_DisconnectBtn"] = "Odpojiť",
        ["Skpp_VerifyBtn"] = "Overiť / Obnoviť profil",
        ["Skpp_Verifying"] = "Overujem...",
        ["Skpp_RoleCoach"] = "Tréner",
        ["Skpp_RoleStudent"] = "Zverenec / Študent",
        ["Skpp_AccountInfo"] = "Prepojený účet",
        ["Skpp_CoachingGroups"] = "Tréningové skupiny",
        ["Skpp_NoGroups"] = "K tomuto účtu nie sú priradené žiadne tréningové skupiny.",
        ["Skpp_PrimaryCoach"] = "Hlavný tréner",
        ["Skpp_StudentsCount"] = "{0} zapísaných zverencov",
        ["Skpp_Ratings"] = "FIDE ELO",
        ["Skpp_FideId"] = "FIDE ID",
        ["Skpp_ConnectedSuccess"] = "Úspešne pripojené k portálu!",

        // Student Club Homeworks
        ["Homework_Tab_Worksheets"] = "Pracovné listy & Tlač",
        ["Homework_Tab_ClubAssigned"] = "Klubové domáce úlohy",
        ["Homework_Club_NotConnected"] = "Nie ste pripojený ku klubovému portálu",
        ["Homework_Club_NotConnectedDesc"] = "Prepojte Caissalytics s klubovým portálom v Riadiacom centre pre automatické prijímanie úloh od vášho trénera.",
        ["Homework_Club_ConnectBtn"] = "Pripojiť v nastaveniach ⚙️",
        ["Homework_Club_Loading"] = "Nahrávam zadané klubové úlohy...",
        ["Homework_Club_NoTasks"] = "Zatiaľ žiadne zadané úlohy",
        ["Homework_Club_NoTasksDesc"] = "Tréner pre vašu tréningovú skupinu zatiaľ nezadal žiadne domáce úlohy.",
        ["Homework_Club_Refresh"] = "Obnoviť úlohy",
        ["Homework_Club_DueDate"] = "Termín: {0}",
        ["Homework_Club_NoDueDate"] = "Bez termínu",
        ["Homework_Club_Overdue"] = "Po termíne",
        ["Homework_Club_AssignedBy"] = "Zadal: {0}",
        ["Homework_Club_Status_Assigned"] = "Čaká na vyriešenie",
        ["Homework_Club_Status_Submitted"] = "Odovzdané",
        ["Homework_Club_Status_Reviewed"] = "Ohodnotené",
        ["Homework_Club_SolveTask"] = "Riešiť úlohu",
        ["Homework_Club_ViewSubmission"] = "Zobraziť odovzdanie",
        ["Homework_Solver_Back"] = "Späť na klubové úlohy",
        ["Homework_Solver_Instructions"] = "Zadanie a inštrukcie trénera",
        ["Homework_Solver_YourSolution"] = "Vaše navrhované riešenie",
        ["Homework_Solver_MovesLine"] = "Ťahy zahrané na šachovnici",
        ["Homework_Solver_Explanation"] = "Slovné vysvetlenie / poznámky k riešeniu",
        ["Homework_Solver_ExplanationPlaceholder"] = "Napíšte postup vášho uvažovania, hlavnú obranu súpera alebo motív...",
        ["Homework_Solver_SubmitBtn"] = "Odovzdať riešenie trénerovi",
        ["Homework_Solver_Submitting"] = "Odosielam riešenie...",
        ["Homework_Solver_ResetBoard"] = "Základná pozícia",
        ["Homework_Solver_SubmittedOn"] = "Odovzdané dňa {0}",
        ["Homework_Solver_WaitingReview"] = "Riešenie bolo úspešne odoslané a čaká na kontrolu trénerom.",
        ["Homework_Solver_ReviewedOn"] = "Ohodnotené trénerom dňa {0}",
        ["Homework_Solver_PointsAwarded"] = "Získané body: {0} b",
        ["Homework_Solver_CoachFeedback"] = "Spätná väzba trénera",
        ["Homework_Solver_OfficialSolution"] = "Oficiálne trénerské riešenie",
        ["Homework_Solver_SuccessToast"] = "Riešenie bolo úspešne odovzdané trénerovi!",

        // Club & Coaching Group Messages
        ["Messages_Title"] = "Klubové správy",
        ["Messages_NewMessage"] = "Nová správa",
        ["Messages_Refresh"] = "Obnoviť správy",
        ["Messages_SearchPlaceholder"] = "Hľadať v správach...",
        ["Messages_Filter_All"] = "Všetky",
        ["Messages_Filter_Unread"] = "Neprečítané",
        ["Messages_Loading"] = "Načítavam klubové správy...",
        ["Messages_NoMessages"] = "Žiadne správy",
        ["Messages_UnreadTag"] = "Neprečítaná správa",
        ["Messages_System"] = "Systém",
        ["Messages_Direct"] = "Priama",
        ["Messages_Coach"] = "Tréner",
        ["Messages_ReplyTitle"] = "Odpoveď na správu",
        ["Messages_SendTo"] = "Komu (Tréningová skupina / Príjemca)",
        ["Messages_NoGroupsAvailable"] = "Nie sú k dispozícii žiadne tréningové skupiny",
        ["Messages_Subject"] = "Predmet",
        ["Messages_SubjectPlaceholder"] = "Zadajte predmet správy...",
        ["Messages_Body"] = "Text správy",
        ["Messages_BodyPlaceholder"] = "Napíšte svoju správu trénerovi alebo skupine...",
        ["Messages_Sending"] = "Odosielam...",
        ["Messages_SendBtn"] = "Odoslať správu",
        ["Messages_ReplyBtn"] = "Odpovedať",
        ["Messages_ReferenceHomeworkTitle"] = "Priradená domáca úloha",
        ["Messages_ReferenceHomeworkDesc"] = "Táto správa sa týka online domácej úlohy.",
        ["Messages_OpenReferenceTask"] = "Otvoriť domácu úlohu",
        ["Messages_SelectToRead"] = "Nie je vybratá žiadna správa",
        ["Messages_SelectToReadDesc"] = "Vyberte správu zo zoznamu vľavo na prečítanie alebo vytvorte novú.",
        ["Messages_SubjectRequired"] = "Predmet správy nemôže byť prázdny.",
        ["Messages_BodyRequired"] = "Text správy nemôže byť prázdny.",
        ["Messages_SentSuccess"] = "Správa bola úspešne odoslaná!",

        // Practice & Play vs PC
        ["Analysis_PlayVsPc"] = "Hrať proti PC",
        ["PlayVsPc_Title"] = "Hrať proti PC z tejto pozície",
        ["PlayVsPc_Desc"] = "Začnite tréningovú partiu z aktuálnej pozície na šachovnici. Zvoľte si farbu a simulované Elo súpera.",
        ["PlayVsPc_Side"] = "Vaša farba",
        ["PlayVsPc_White"] = "Biely",
        ["PlayVsPc_Black"] = "Čierny",
        ["PlayVsPc_Current"] = "Hráč na ťahu ({0})",
        ["PlayVsPc_OpponentElo"] = "Sila súpera (Elo: {0})",
        ["PlayVsPc_Preset_Beginner"] = "Začiatočník (1000)",
        ["PlayVsPc_Preset_Casual"] = "Rekreačný (1300)",
        ["PlayVsPc_Preset_Intermediate"] = "Mierne pokročilý (1600)",
        ["PlayVsPc_Preset_Club"] = "Klubový hráč (1900)",
        ["PlayVsPc_Preset_Master"] = "Majster (2200)",
        ["PlayVsPc_Preset_Grandmaster"] = "Veľmajster (2500+)",
        ["PlayVsPc_Start"] = "Spustiť partiu",
        ["PlayVsPc_Cancel"] = "Zrušiť",

        ["Practice_Opponent"] = "Počítačový bot",
        ["Practice_Thinking"] = "Počítač premýšľa...",
        ["Practice_YourTurn"] = "Váš ťah",
        ["Practice_Takeback"] = "Vrátiť ťah",
        ["Practice_Hint"] = "Nápoveda",
        ["Practice_Resign"] = "Vzdať sa",
        ["Practice_Draw"] = "Ponúknuť remízu",
        ["Practice_NewGame"] = "Nová partia",
        ["Practice_Analyze"] = "Analyzovať partiu",
        ["Practice_EvalToggle"] = "Hodnotenie",
        ["Practice_Victory"] = "Mat! Vyhrali ste! 🎉",
        ["Practice_Defeat"] = "Mat! Počítač vyhral.",
        ["Practice_Stalemate"] = "Remíza patom!",
        ["Practice_DrawAgreed"] = "Dohodnutá remíza.",
        ["Practice_Resigned"] = "Vzdali ste sa.",
        ["Practice_CompResigned"] = "Počítač sa vzdal. Vyhrali ste! 🎉",
        ["Practice_HintText"] = "💡 Odporúčaný ťah: {0}",
        ["Practice_HintNotFound"] = "Nebol nájdený žiadny jednoznačný ťah.",
        ["Practice_StrengthTitle"] = "Sila a obtiažnosť bota",
        ["Practice_StrengthDesc"] = "Nastavte simulovaný rating počítača pred začiatkom alebo po skončení partie.",
        ["Practice_StrengthLocked"] = "Uzamknuté v partii",
        ["Practice_DifficultyLockedDesc"] = "Sila bota je po začiatku partie uzamknutá. Na zmenu obtiažnosti dokončite alebo reštartujte partiu.",
        ["Practice_NewMatchTitle"] = "Nastavenie novej partie",
        ["Practice_SideWhite"] = "Hrať za bieleho ♔",
        ["Practice_SideBlack"] = "Hrať za čierneho ♚",
        ["Practice_StartNew"] = "Spustiť novú partiu",

        ["Practice_Engine_Stockfish"] = "Stockfish",
        ["Practice_Engine_Maia"] = "Neurónová sieť Maia",
        ["Practice_Maia_Desc"] = "Autentická predikcia ľudských ťahov natrénovaná priamo na miliónoch partií reálnych hráčov.",
        ["Practice_Maia_DownloadBtn"] = "Stiahnuť Maia {0} (~1.2 MB)",
        ["Practice_Maia_Downloading"] = "Sťahovanie Maia {0} ({1}%)...",
        ["Practice_Maia_Lc0Missing"] = "Na beh modelov Maia je potrebný motor Leela Chess Zero (lc0). Prejdite do Nastavenia → Motory a nainštalujte ho alebo zadajte vlastnú cestu.",
        ["Practice_Maia_Lc0Missing_Tooltip"] = "lc0 nie je nainštalované — prejdite do Nastavenia → Motory",
        ["Practice_Maia_Lc0Configure"] = "Nastaviť lc0 v Nastaveniach",
        ["Settings_Maia_Title"] = "Neurónové siete Maia Chess",
        ["Settings_Maia_Subtitle"] = "Modely predikcie ľudských ťahov (1100 až 1900 Elo) poháňané motorom Leela Chess Zero (lc0).",
        ["Settings_Maia_Desc"] = "Modely predikcie ľudských ťahov (1100 až 1900 Elo) poháňané motorom Leela Chess Zero (lc0).",
        ["Settings_Maia_Lc0Status"] = "Stav binárky Lc0",
        ["Settings_Maia_Lc0Detected"] = "Binárka Lc0 pripravená: {0}",
        ["Settings_Maia_Lc0NotFound"] = "Binárka Lc0 nebola nájdená v PATH ani v spravovanom priečinku.",
        ["Settings_Maia_CustomLc0Placeholder"] = "Cesta k spustiteľnému súboru lc0...",
        ["Settings_Maia_CustomLc0Path"] = "Vlastná cesta k binárke lc0",
        ["Settings_Maia_CustomLc0Hint"] = "Zadajte celú cestu k binárke lc0, ak je nainštalovaná v neštandardnom umiestnení.",
        ["Settings_Maia_Lc0PathSaved"] = "Vlastná cesta k lc0 bola úspešne uložená!",
        ["Settings_Maia_ModelsTitle"] = "Váhy neurónových sietí Maia (~1.2 MB každá)",
        ["Settings_Maia_ModelsDesc"] = "Offline váhy trénované na ľudských partiách s ratingom 1100 až 1900.",
        ["Settings_Maia_DownloadAll"] = "Stiahnuť všetky modely (11 MB)",
        ["Settings_Maia_DownloadAllProgress"] = "Sťahovanie všetkých modelov ({0}%)...",
        ["Settings_Maia_Installed"] = "Nainštalované",
        ["Settings_Maia_NotInstalled"] = "Nestiahnuté",
        ["Settings_Maia_Download"] = "Stiahnuť",
        ["Settings_Maia_Size"] = "{0:F1} MB",
        ["Settings_Maia_Lc0Download"] = "⬇ Stiahnuť lc0 jedným kliknutím (Windows)",
        ["Settings_Maia_Lc0Build"] = "Zostaviť lc0 zo zdrojového kódu (~2 min)",
        ["Settings_Maia_Lc0Required"] = "Najprv nainštalujte lc0, aby ste mohli sťahovať modely Maia."
    };
}
