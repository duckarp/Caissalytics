...
| **Control Center** | Settings, engines & customization hub | Web Platform Hub connection (ŠK Považské Podhradie / generic hub), engine management & removal, Syzygy tablebase folder path, online probe toggle, Lichess API token, board themes, sound triggers, language switcher (EN/SK), updater |
